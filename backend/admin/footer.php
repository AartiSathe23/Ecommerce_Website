<div class="footer_part">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer_iner text-center">
                            <p>2024 © Essentia | All rights reserved</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="scripts/jquery1-3.4.1.min.js"></script>

    <script src="scripts/popper1.min.js"></script>
    ...
    <script src="vendors/datatable/js/scriptszip.min.js"></script>
    ...
    <script src="scripts/dashboard_init.js"></script>
